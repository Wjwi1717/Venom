...
int main(int argc, char* argv[]) {
    if (argc != 4) {
        printf("Usage: ./venompapa <IP> <PORT> <DURATION>\n", argv[0]);
        return 1;
    }
    ...
    printf("MADE BY @venompapa %s:%d for %d seconds with %d threads...\n",
    ...
    printf("FUCKED ATTACK @venompapa1010 HOST IP %s on port %d for %d seconds\n",
